...
/**
 * This event is called when a player exit regions.
 * It allows to easily get the exited regions.
 */
public class PlayerExitRegionEvent extends PlayerEvent {
    ...
    public PlayerExitRegionEvent(final Player player, Set<ProtectedRegion> exited) {
        super(player);
        this.exited = exited;
    }
